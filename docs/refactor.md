...
各 app の sill 採用（origin/main）: **wand `0.6.0`** ✅（[#143](https://github.com/akira-toriyama/wand/pull/143)・
line-pets dedup と同時 bump）/ facet `0.5.0` / halo `0.5.0` / glance `0.5.0` /
perch `0.5.0`（[#114](https://github.com/akira-toriyama/perch/pull/114) ✅）。
**Track 0 完了**。残る 0.5.0 組は Track 2 の各 dedup と同時に 0.6.0 へ。
